...
RSpec.describe CrystalballProphecyDataSource do
  ...
  describe 'getter and setter' do
    ...
    it 'allows getting and setting values' do
      ...
      expect(data_source['app/some_file.rb']).to match_array(%w[spec/some_spec.rb])
      data_source['spec/some_other_spec.rb'] = %w[app/some_file.rb app/bar.rb]
      expect(data_source['app/some_file.rb']).to match_array(%w[spec/some_spec.rb spec/some_other_spec.rb])
    end
  end
  ...
  describe '#affected_examples_for' do
    it 'returns affected examples for single file' do
      data_source['spec/some_spec.rb'] = %w[app/some_file.rb app/some_other_file.rb]
      data_source['spec/some_other_spec.rb'] = %w[app/some_file.rb app/bar.rb]
      expect(data_source.affected_examples_for('app/some_file.rb')).to match_array(%w[spec/some_spec.rb spec/some_other_spec.rb])
    end
    ...
    it 'returns affected examples for list of files' do
      ...
      expect(data_source.affected_examples_for(%w[app/some_file.rb app/bar.rb])).to match_array(%w[spec/some_spec.rb spec/some_other_spec.rb spec/yet_another_spec.rb])
    end
  end
  ...
  describe '#examples' do
    it 'returns all stored examples' do
      data_source['spec/some_spec.rb'] = %w[app/some_file.rb app/some_other_file.rb]
      data_source['spec/some_other_spec.rb'] = %w[app/some_file.rb app/bar.rb]
      expect(data_source.examples).to match_array(%w[spec/some_spec.rb spec/some_other_spec.rb])
    end
  end
